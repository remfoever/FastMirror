...
/* USER CODE BEGIN EV */
extern uint8_t huart1_rx_buffer[100];//接收数组
extern uint8_t huart1_tx_buffer[100];//发送数组
...
void USART1_IRQHandler(void)
{
  ...
  /* USER CODE BEGIN USART1_IRQn 1 */
	...
	{ 
		...
		huart1_rx_len =100-temp; //计算出数据长度
		HandleReceivedData(huart1_rx_buffer,huart1_rx_len);//将接收到的数据转入处理函数执行
//		RS485_send_data(huart1_rx_buffer,huart1_rx_len);
		HAL_UART_Receive_DMA(&huart1,huart1_rx_buffer,100);//开启DMA接收，方便下一次接收数据	
	}
